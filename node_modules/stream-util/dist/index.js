...
var LogStream = function (_Transform) {
  ...
  function LogStream() {
    var logfn = arguments.length <= 0 || arguments[0] === undefined ? function (chunk) {
      return console.log(chunk);
    } : arguments[0];
    (0, _classCallCheck3.default)(this, LogStream);

    var _this = (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(LogStream).call(this, { objectMode: true }));
...
var FromArrayStream = function (_Readable) {
  ...
  function FromArrayStream() {
    ...
    var _this2 = (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(FromArrayStream).call(this, { objectMode: true }));
...
var ToArrayStream = function (_Transform2) {
  ...
  function ToArrayStream() {
    ...
    var _this4 = (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(ToArrayStream).call(this, { objectMode: true }));
...
var ToObjectStream = function (_Transform3) {
  ...
  function ToObjectStream() {
    ...
    var _this5 = (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(ToObjectStream).call(this, { objectMode: true }));
...
var ReadAsyncStream = function (_Readable2) {
  ...
  function ReadAsyncStream(fn) {
    ...
    var _this6 = (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(ReadAsyncStream).call(this, { objectMode: true }));
...
var ReadSyncStream = function (_Readable3) {
  ...
  function ReadSyncStream(fn) {
    ...
    var _this8 = (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(ReadSyncStream).call(this, { objectMode: true }));
...
var MapSyncStream = function (_Transform4) {
  ...
  function MapSyncStream(fn) {
    ...
    var _this9 = (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(MapSyncStream).call(this, { objectMode: true }));
...
var MapAsyncStream = function (_Transform5) {
  ...
  function MapAsyncStream(fn) {
    ...
    var _this10 = (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(MapAsyncStream).call(this, { objectMode: true }));
...
var ThroughAsyncStream = function (_Transform6) {
  ...
  function ThroughAsyncStream(fn) {
    ...
    var _this11 = (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(ThroughAsyncStream).call(this, { objectMode: true }));
...
var ThroughSyncStream = function (_Transform7) {
  ...
  function ThroughSyncStream(fn) {
    ...
    var _this12 = (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(ThroughSyncStream).call(this, { objectMode: true }));
...
var ConcatStream = function (_Readable4) {
  ...
  function ConcatStream(streams) {
    ...
    var _this13 = (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(ConcatStream).call(this, { objectMode: true }));
...
var FilterSyncStream = function (_Transform8) {
  ...
  function FilterSyncStream(fn) {
    ...
    var _this15 = (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(FilterSyncStream).call(this, { objectMode: true }));
...
var FilterAsyncStream = function (_Transform9) {
  ...
  function FilterAsyncStream(fn) {
    ...
    var _this16 = (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(FilterAsyncStream).call(this, { objectMode: true }));
